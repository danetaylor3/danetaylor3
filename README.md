...
🚀 Current tech stack:
* Design: Figma, design systems, component libraries, UX research, prototyping
* Frontend: TypeScript, React, Next.js, Tailwind CSS, HTML/CSS, Storybook
* Backend: LLM API integration, prompt UI, Docker, Vercel, CI/CD, REST APIs
